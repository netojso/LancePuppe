...
// }
    ...
    try{
      (async () => {
        ...
        await page.goto('https://www.lance24h.com.br/Detalhes.php?Titulo=IMac-com-Intel-Core-i5-Dual-Core-8GB-1TB-21.5-Prata-MMQA2BZA-_-Apple&Codigo=43030')
        await page.waitFor(2000)

        const timer = await page.evaluate ( async () =>{
            
          const contador = document.getElementById("L_ContDown_1_43030")
          const contador2 = document.getElementById("L_ContDown_2_43030")
          console.log(contador.textContent)
          console.log(contador2.textContent)

          if (contador == 0 && contador2 == 8) {
              await page.click('div#L_BotaoA_43030 a')
          }
        })
      })()
    } catch (err) {
